...
public class NotifProses extends AppCompatActivity {
    ...
    protected static Integer orderStatusCap, orderStatusKop,orderStatusCok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                orderStatusCap = snapshot.child("cappucino").child("orderStatus").getValue(Integer.class);
                orderStatusKop = snapshot.child("kopisusu").child("orderStatus").getValue(Integer.class);
                orderStatusCok = snapshot.child("coklat").child("orderStatus").getValue(Integer.class);
                if(status == 0){
